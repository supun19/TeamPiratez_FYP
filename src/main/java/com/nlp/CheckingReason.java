...
public class CheckingReason {
	...
	public boolean isCorrectStudentAnswer(String studentReation, String schemaReason) {

		
		return mapper.compaire(studentReation,schemaReason , dictionary);
	...
	public void fillDictionary(Dictionary dictionary) {
		...
		dictionary.putTokensToDictionary("දත්තය", new String[] { "දත්තය"});
	}
	...
	public boolean isReasonValide(Reason reason, String Text, Dictionary dictionary, EnumDictionary enumDictionary,
			SinhalaMapper mapper) {
